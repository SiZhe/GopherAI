...
const (
	...
	CodeInvalidAccessToken  Code = 2006
	CodeInvalidRefreshToken Code = 2007
	CodeNotLogin            Code = 2008
	CodeInvalidCaptcha      Code = 2009
	CodeRecordNotFound      Code = 20010
	CodeIllegalPassword     Code = 2011
...
var msg = map[Code]string{
	...
	CodeInvalidAccessToken:  "无效的AccessToken",
	CodeInvalidRefreshToken: "无效的RefreshToken",
	CodeNotLogin:            "用户未登录",
